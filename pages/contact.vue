...
<template>
    ...
    >
        ...
        >
            <div class="flex flex-col w-full max-w-4xl px-4 mx-auto md:px-0">
                <LazyFormContact />
                <div class="mt-8">
                    <h3
                ...
                <div
                    class="flex flex-col items-center justify-center w-full mx-auto mt-8 space-y-1 md:items-start md:flex-row md:justify-between"
                >
                    ...
                    <div>
                        <h3
                            class="text-xl font-semibold text-black md:text-2xl"
                        >
                            Margaux BENDELAC
                        </h3>
                        <p
                            class="mb-2 text-xl font-medium text-black md:text-2xl"
                        >
                            Avocate à la Cour
                        </p>
                        <p
                            class="text-xl font-medium text-black md:text-2xl md:hidden"
                        >
                            <span class="inline-block w-4 h-4"
                                ><AtSymbolIcon
                            /></span>
