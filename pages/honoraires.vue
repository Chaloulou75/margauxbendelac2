<template>
  <div
    class="flex flex-col items-center justify-center w-full h-full px-2 py-8 mx-auto max-w-7xl md:px-8"
  >
    <h1
    ...
    <section
      class="flex flex-col w-full mx-auto my-4 space-y-8 md:space-y-12 md:px-6"
    >
      <div>
        <h2
        ...
        <p class="mb-3 text-xl text-justify text-black md:text-2xl md:mb-5">
          Les honoraires sont fixés selon les usages, en fonction de la
          situation de fortune du client, de la difficulté de l’affaire, des
          frais exposés par l’avocat, de la notoriété et des diligences de
          celui-ci.
        </p>
        <p class="mb-3 text-xl text-justify text-black md:text-2xl md:mb-5">
      ...
      <div>
        ...
        <p class="mb-3 text-xl text-justify text-black md:text-2xl md:mb-5">
          Vous avez la possibilité de saisir le médiateur de la consommation de
          la profession d’avocat, qui vous offrira son aide afin de trouver une
          solution à l’amiable ou de saisir le bâtonnier de l’ordre des avocats,
          dans le cas où aucune solution à l’amiable n’aurait été trouvée.
        </p>
        <p class="mb-3 text-xl text-justify text-black md:text-2xl md:mb-5">
          Pour vous assister dans cette démarche, faites appel au médiateur dont
