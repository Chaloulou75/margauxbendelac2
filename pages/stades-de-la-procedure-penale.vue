<template>
  ...
  >
    ...
    <div class="my-4 space-y-12">
      ...
      <section id="gav" class="space-y-4">
        <h2 class="text-xl font-semibold text-black md:text-2xl">
          Garde à vue:
        </h2>
        <p class="mb-3 text-xl text-justify text-black md:text-2xl md:mb-5">
      ...
      <section id="amenagement" class="space-y-4">
        <h2 class="text-xl font-semibold text-black md:text-2xl">
          Aménagement de peine:
        </h2>
        <p class="mb-3 text-xl text-justify text-black md:text-2xl md:mb-5">
          L'aménagement de peine constitue une dimension cruciale de
          l’intervention du cabinet. Nous travaillons activement pour obtenir
          des mesures alternatives à l'incarcération, lorsque cela est possible
          et en fonction des spécificités de chaque dossier.
        </p>
      </section>

      <p class="mb-3 text-xl text-justify text-black md:text-2xl md:mb-5">
        Que ce soit par le biais du placement sous surveillance électronique,
        des travaux d'intérêt général, de la semi-liberté, du placement à
        l’extérieur, ou de la liberté conditionnelle, le cabinet envisage toutes
        les possibilités pour vous accompagner dans votre processus de
        réinsertion.
      </p>
    </div>
  </div>
